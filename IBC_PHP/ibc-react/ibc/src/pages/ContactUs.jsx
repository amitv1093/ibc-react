...
const [formvalue, setFormvalue] = useState({name:'', email:'', subject:'', phone:'', message:''});
...
const handleSubmit = async(e) => {
  ...
  const formData= {name:formvalue.name, email:formvalue.email, subject:formvalue.subject, phone:formvalue.phone, message:formvalue.message};
  const res = await axios.post("https://localhost/api/insert.php",formData);
          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
            ...
            <div className="mt-5 sm:mx-auto sm:w-full">
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  <div className="name">
                    <input onChange={handleInput} value={formvalue.name} id="name" name="name" type="text" placeholder='  Name'   className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                </div>
                <div>
                  <div className="email">
                    <input onChange={handleInput} value={formvalue.email} id="email" name="email" type="email" placeholder='  Email'   className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                </div>
                <div>
                  <div className="subject">
                    <input onChange={handleInput} value={formvalue.subject} id="subject" name="subject" type="text" placeholder='  Subject'   className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                </div>
                <div>
                  <div className="phone">
                    <input onChange={handleInput} value={formvalue.phone} id="phone" name="phone" type="phone" placeholder='  Phone Number'   className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                </div>
                <div>
                  <div className="message">
                    <textarea onChange={handleInput} value={formvalue.message} name="message" id="message" type="text" placeholder='  Message'  cols="100" rows="4"  className="block w-full rounded-md border-0 py-1.5 px-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                  </div>
                </div><div>
