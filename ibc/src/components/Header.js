...
const navigation = [
  { name: "Home", href: "/react", current: true },
  { name: "About IBC", href: "/react/AboutUs", current: false },
  { name: "Services", href: "/react/Services", current: false },
  { name: "Contact Us", href: "/react/ContactUs", current: false },
  { name: "Video Tutorial", href: "/react/VideoTut", current: false },
  { name: "Our Careers", href: "/react/OurCareers", current: false },
];
...
export default function Header() {
  ...
  return (
    <>
                        ...
                        {isUserLoggedIn && (
                          <div className="welcome-wrapper">
                            <img
                              ...
                              alt=""
                            />
                            <h6 className="welcome-text text-white">
                              Hi, {userDetails.name}
                            </h6>
                          </div>
                        )}
      ...
      <div className="sm:ml-6 sm:block bg-gray-800 ">
        <div className="flex space-x-4">
          {navigation.map((item) => (
            <Link
              key={item.name}
